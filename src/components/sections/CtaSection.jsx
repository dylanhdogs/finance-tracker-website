    ...
    <section id="cta" className="px-5 sm:px-6 py-12 md:py-16 lg:py-[65px] mx-auto max-w-[1440px] scroll-mt-32">
      ...
      >
        ...
        <div className="relative z-10 flex-1">
          <p className="text-white/70 text-[0.92rem] font-black tracking-[0.18em] uppercase mb-4">Start tracking shared expenses clearly.</p>
        ...
        >
          <span className="mb-4 inline-flex rounded-full bg-accent-2/10 px-3 py-1.5 text-white text-xs font-black uppercase tracking-[0.14em]">Checkout</span>
          <span className="text-white font-black">Monthly plan</span>
          <strong className="block my-2 text-[3.4rem] sm:text-[4.4rem] font-black tracking-tight leading-none">$19.99</strong>
          <p className="text-white/70 mb-4">Per month · Cancel anytime</p>
          <motion.a
            href="/download.html"
