...
export default function AudienceSection() {
  return (
    <section id="audience" className="px-5 sm:px-6 py-12 md:py-16 lg:py-[65px] mx-auto max-w-[1440px] scroll-mt-32 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[1.28fr_0.72fr] gap-7 items-center">
        ...
        <Reveal direction="right">
          <div className="flex flex-col gap-4">
            <p className="text-white/70 text-[0.92rem] font-black tracking-[0.18em] uppercase">Who this is for</p>
